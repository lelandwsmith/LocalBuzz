...
- (void)joinRoomUsingNickname:(NSString *)desiredNickname fromJID:(XMPPJID *)jid history:(NSXMLElement *)history
{
	[self joinRoomUsingNickname:desiredNickname fromJID:jid history:history password:nil];
}

- (void)joinRoomUsingNickname:(NSString *)desiredNickname fromJID:(XMPPJID *)jid history:(NSXMLElement *)history password:(NSString *)passwd
{
	dispatch_block_t block = ^{ @autoreleasepool {
		...
		XMPPPresence *presence = [XMPPPresence presenceWithType:nil from:jid to:myRoomJID];
		[presence addChild:x];
